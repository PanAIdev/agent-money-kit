...
| | |
|---|---|
| **Store** | [agent-money-kit.vercel.app](https://agent-money-kit.vercel.app) |
| **Checkout** | [Buy now — $19](https://buy.polar.sh/polar_cl_rEbB7yE5SGJTnCcZmqPnWWJ9YlWkbSpxGNTJb0DowEz) |

Instant digital download (PDF + Markdown ZIP).
...
Preview Day 1 of the sprint (rules, offer lock, and the starter prompt) before you buy:

- On the store: [Free sample section](https://agent-money-kit.vercel.app/#sample)
- In this repo: [`SAMPLE.md`](./SAMPLE.md)
...
**Do I need to code?**  
No. If you can use an AI chat/agent and send email or LinkedIn messages, you’re fine.

**Is this a video course?**  
No. It’s a focused document kit — faster to use, easier to search, reusable as templates.

**How is this different from free prompt lists?**  
Free lists give prompts. This kit connects prompts to a money sprint, product shipping plan, outreach scripts, and offer/pricing templates.

---

## Buy

**[$19 intro → Checkout](https://buy.polar.sh/polar_cl_rEbB7yE5SGJTnCcZmqPnWWJ9YlWkbSpxGNTJb0DowEz)** · [Store & details](https://agent-money-kit.vercel.app)

Open the 7-Day Sprint. Make the next move today.

---

## Contact

Questions? **contact@panai.dev**

---

Built by [PanAI](https://panai.dev) for people who ship.
